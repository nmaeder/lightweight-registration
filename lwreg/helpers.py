...
def interactive_config():
    ...
    config['standardization'] = (
        input('Choose your standardization: (none, sanitize, [fragment], charge, tautomer, super, canonicalize) ')
        or 'fragment'
    )
    ...
    if conf_option == 'no':
        ...
        invariantConfs = (
            input(
                'Would you like to register your conformers as translationally and rotationally invariant? ([yes]/no)'
            )
            or 'yes'
        )
